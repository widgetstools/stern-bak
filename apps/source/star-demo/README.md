...
| `…/#/blotters/marketsgrid` | `BlotterHost` blotter (`gridId: star-demo-blotter`) |
| `…/#/blotters/ssrmmarketsgrid?instanceId=<configId>` | `BlotterHost` — SSRM when live provider type is `stomp-ssrm`; instance id from launch URL / registry |
