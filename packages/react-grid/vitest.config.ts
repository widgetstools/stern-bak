    ...
    projects: [
      {
        ...
        resolve: {
          ...
          alias: [
            ...
            { find: '@wellsfargo-starui/engine', replacement: resolve(__dirname, '../core/engine/src/index.ts') },
            ...
            { find: '@wellsfargo-starui/host', replacement: resolve(__dirname, '../core/host/src/index.ts') },
