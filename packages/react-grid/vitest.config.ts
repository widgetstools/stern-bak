    ...
    projects: [
      {
        ...
        resolve: {
          ...
          alias: [
            ...
            { find: '@wellsfargo-starui/types/shared/fieldPath', replacement: resolve(__dirname, '../types/shared-types/src/fieldPath.ts') },
            { find: '@wellsfargo-starui/types/shared/rowPath', replacement: resolve(__dirname, '../types/shared-types/src/rowPath.ts') },
