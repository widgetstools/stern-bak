/**
 * INTERNAL barrel — the full customizer surface for in-package widget-tree
 * imports. NOT exported by any package.json subpath. The public
 * `./customizer` surface is the curated `index.ts`; add names there only
 * with a named cross-package consumer.
 */
/**
