...
const STARUI_DARK_CHROME = {
  ...
  columnBorder: { style: 'solid' as const, width: 1, color: 'oklch(0.40 0.016 258 / 0.55)' },
  headerColumnBorder: { style: 'solid' as const, width: 1, color: 'oklch(0.42 0.017 258 / 0.6)' },
