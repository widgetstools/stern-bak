...
**Interactive demo:** the former `platform-hooks-demo` app was deleted with the app curation; the hooks it exercised are covered by unit tests in `packages/data` and the surviving demo apps.
